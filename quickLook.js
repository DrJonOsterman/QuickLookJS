...
(function(o){
	...
	function print(message, fileName, lineNumber, word){
		var tempStr;
		if (message == 'found') { tempStr = fileName + ': <b>' + word + '</b> found on line ' + lineNumber; }
		else if (message == 'clean') { tempStr = fileName + ' is clean'; }
		else if (message == 'unsupported') { tempStr = "Sorry, your browser does not support the necessary features to use this service."; }
